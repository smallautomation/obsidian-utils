...
```
cd existing_repo
git remote add origin https://gitlab.com/my6145916/obsidian-utils.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/my6145916/obsidian-utils/-/settings/integrations)
